...
import { PermisosEspecialesParametrosComponent } from '../permisos-especiales-parametros/permisos-especiales-parametros.component';
@Component({
  selector: 'app-modal-generar-autorizacion',
  templateUrl: './modal-generar-autorizacion.component.html',
  styleUrls: ['./modal-generar-autorizacion.component.scss']
})
export class ModalGenerarAutorizacionComponent implements OnInit {
  ...
  modalPermisoEspecial(): void {
    console.log(this.datoA);
    console.log(this.sevicio_select);

    this.dialog.open(PermisosEspecialesParametrosComponent, {
      width: 'auto',
      height: 'auto',
