...
@Component({
  selector: 'app-permisos-especiales-create',
  templateUrl: './permisos-especiales-create.component.html',
  styleUrls: ['./permisos-especiales-create.component.scss']
})
export class PermisosEspecialesCreateComponent implements OnInit {
