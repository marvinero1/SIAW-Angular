...
export class NumeraciontransferenciasCreateComponent implements OnInit {
  ...
  public ventana="tipoTransferencia-create"
  ...
  submitData(){
    ...
    let errorMessage = "La Ruta presenta fallos al hacer la creacion"+"Ruta:-- /fondos/mant/fntipotransferencia/";
    
    return this.api.create("/fondos/mant/fntipotransferencia/"+this.userConn, data)
      .subscribe({
        next: (datav) => {
