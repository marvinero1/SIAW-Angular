...
@Component({
  selector: 'app-nummovfondos-create',
  templateUrl: './nummovfondos-create.component.html',
  styleUrls: ['./nummovfondos-create.component.scss']
})
export class NummovfondosCreateComponent implements OnInit {
  ...
  submitData(){
    ...
    let errorMessage = "La Ruta presenta fallos al hacer la creacion"+"Ruta:-- /fondos/mant/fntipocambio/";
    
    return this.api.create("/fondos/mant/fntipocambio/"+this.userConn, data)
      .subscribe({
        next: (datav) => {
