...
@Component({
  ...
  styleUrls: ['./numprovisioncompra-create.component.scss']
})
export class NumprovisioncompraCreateComponent implements OnInit {
  ...
  public ventana = "numProvisionCompra-create"
  public detalle = "numProvisionCompra-detalle";
  public tipo = "transaccion-numProvisionCompra-POST";
  ...
  submitData() {
    ...
    let errorMessage = "La Ruta presenta fallos al hacer la creacion" + "Ruta:-- /compras/mant/cmtipoprovision/";

    return this.api.create("/compras/mant/cmtipoprovision/" + this.userConn, data)
      .subscribe({
        next: (datav) => {
